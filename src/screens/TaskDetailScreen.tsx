...
import { NoteAttachmentView, fixConvexStorageUrl, type NoteAttachmentData } from '../components/NoteAttachmentView';
import {
        ...
        >
          ...
          >
            ...
            <View style={styles.taskActionsList}>
              ...
              {!isActionTask && requiresTaskSignature && !hasTaskSignature && hasValidConvexId && (
                <TouchableOpacity
                  style={[styles.taskActionRow, { borderColor: isDarkMode ? 'rgba(255,255,255,0.06)' : 'rgba(0,0,0,0.04)' }]}
                  onPress={() => {
                    setTaskActionsVisible(false);
